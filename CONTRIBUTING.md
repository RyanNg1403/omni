...
Omni came from my own need for a fast, simple, effective workspace manager for coding agents. I care a lot about how it looks, feels, and works, so many design and technical decisions here are deliberate.

This guide exists so I can keep omni manageable as a solo project and keep it from drifting from what it is supposed to be.

## The One Rule

**You must understand your code.** If you cannot explain what your changes do, how they behave at the edges, and how they fit omni's existing design, your PR will be closed.

Using AI to write code is fine. Submitting code you do not understand is not.

## Omni is opinionated

Omni has a specific direction for how it should look, feel, and work.
...
- why this change belongs in omni
...
If a PR introduces a feature without prior alignment, or changes omni's feel without discussion, it will likely be closed.
