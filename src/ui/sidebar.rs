...
mod tests {
    ...
    fn grouped_child_label_uses_short_branch_for_auto_named_workspace() {
        assert_eq!(
            grouped_child_display_label("omni-issue", Some("worktree/issue-137"), false),
            "issue-137"
        );
    }
    ...
    fn parent_workspace_row_stays_clickable_when_grouped() {
        ...
        app.workspaces = vec![
            workspace_with_worktree_space("main", Some("repo-key"), "/repo/omni"),
            workspace_with_worktree_space("issue", Some("repo-key"), "/repo/omni-issue"),
        ];
    ...
    fn linked_only_worktree_members_do_not_form_parentless_group() {
        ...
        app.workspaces = vec![
            workspace_with_worktree_space("issue", Some("repo-key"), "/repo/omni-issue"),
            workspace_with_worktree_space("review", Some("repo-key"), "/repo/omni-review"),
        ];
    ...
    fn compact_space_group_scroll_offset_can_start_inside_group() {
        ...
        app.workspaces = vec![
            workspace_with_worktree_space("main", Some("repo-key"), "/repo/omni"),
            workspace_with_worktree_space("one", Some("repo-key"), "/repo/omni-one"),
            workspace_with_worktree_space("two", Some("repo-key"), "/repo/omni-two"),
        ];
