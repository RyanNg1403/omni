    ...
    fn request_round_trips_for_pane_report_metadata() {
        let request = Request {
            ...
            method: Method::PaneReportMetadata(PaneReportMetadataParams {
                ...
                applies_to_source: Some("omni:claude".into()),
            ...
            result: ResponseResult::WorktreeCreated {
                workspace: WorkspaceInfo {
                    ...
                    worktree: Some(WorkspaceWorktreeInfo {
                        repo_key: "/repo/omni/.git".into(),
                        repo_name: "omni".into(),
                        repo_root: "/repo/omni".into(),
                        checkout_path: "/worktrees/omni/worktree-api".into(),
                ...
                root_pane: PaneInfo {
                    ...
                    tab_id: "w_1:1".into(),
                    focused: true,
                    cwd: Some("/worktrees/omni/worktree-api".into()),
                    label: None,
                    agent: None,
                    title: None,
                    display_agent: None,
                ...
                worktree: WorktreeInfo {
                    path: "/worktrees/omni/worktree-api".into(),
                    branch: Some("worktree/api".into()),
                    is_bare: false,
                    is_detached: false,
                    is_prunable: false,
