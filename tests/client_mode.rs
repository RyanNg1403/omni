...
use support::{
    ...
    read_server_message, register_runtime_dir, register_spawned_omni_pid,
    unregister_spawned_omni_pid, wait_for_file, wait_for_message_variant, wait_for_socket,
    wait_until,
};
...
fn server_unreachable_shows_clear_error() {
    ...
    assert!(
        stderr.contains("Is omni server running?"),
